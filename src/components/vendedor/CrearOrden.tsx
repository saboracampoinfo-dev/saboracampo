    ...
    <div className="space-y-6">
                ...
                <div className="flex-1">
                  <div className="font-semibold text-dark-900 dark:text-light-500">
                    ...
                    {producto.unidadMedida === 'kg' && producto.gramos && (
                      <span className="ml-2 text-sm bg-primary/20 text-primary px-2 py-1 rounded">
                        {producto.gramos}gr
                      </span>
                    )}
                  </div>
      ...
      <div className="bg-primary-100 dark:bg-dark-800 border border-primary rounded-lg p-4">
        ...
        <ul className="space-y-1 text-sm text-dark-700 dark:text-dark-300">
          ...
          <li>• <strong>Productos por kg:</strong> Al seleccionar un producto por kg, elige entre las cantidades predefinidas o ingresa una personalizada</li>
