      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-dark-900 dark:text-light-500 mb-6 animate-fade-in">
            <span className="bg-linear-to-r from-primary-400 via-primary-600 to-primary-400 bg-clip-text text-transparent uppercase"> Sabor a Campo</span>
          </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16">
          <div className="bg-surface dark:bg-dark-800 p-4 rounded-lg shadow-md hover:shadow-xl text-center transition-all duration-300 hover:-translate-y-1 border border-dark-200 dark:border-dark-700">
            ...
            <h3 className="text-xl font-bold text-dark-900 dark:text-light-500 mb-2">Almacén</h3>
            <p className="text-dark-600 dark:text-dark-400">
              Seleccionamos los mejores productos de cada día
            </p>
          </div>
          ...
          <div className="bg-surface dark:bg-dark-800 p-4 rounded-lg shadow-md hover:shadow-xl text-center transition-all duration-300 hover:-translate-y-1 border border-dark-200 dark:border-dark-700">
            ...
            <h3 className="text-xl font-bold text-dark-900 dark:text-light-500 mb-2">Maxiquiosco y Heladeria</h3>
            <p className="text-dark-600 dark:text-dark-400">
              Disfruta de nuestros maxikioscos y heladerías en cada sucursal
            </p>
          </div>
        </div>
