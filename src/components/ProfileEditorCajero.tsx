...
import { FiUser, FiMail, FiPhone, FiMapPin, FiFileText, FiSave, FiClock, FiDollarSign } from 'react-icons/fi';
...
export default function ProfileEditorCajero() {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="md:col-span-2 bg-surface dark:bg-dark-800 rounded-lg shadow-lg p-6 border border-dark-200 dark:border-dark-700">
          <div className="flex items-center space-x-4">
            <div className="w-20 h-20 rounded-full bg-warning-100 dark:bg-warning-900 flex items-center justify-center">
              <FiUser className="w-10 h-10 text-warning" />
            </div>
            <div>
              ...
              <span className="inline-block mt-2 px-3 py-1 text-xs font-semibold rounded-full bg-warning-100 text-warning-800 dark:bg-warning-900 dark:text-warning-200">
                Cajero
              </span>
            </div>
          </div>
        ...
        <div className="bg-surface dark:bg-dark-800 rounded-lg shadow-lg p-6 border border-dark-200 dark:border-dark-700">
          <div className="flex items-center justify-between">
            ...
            <div className="w-12 h-12 rounded-full bg-info-100 dark:bg-info-900 flex items-center justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="bg-surface dark:bg-dark-800 rounded-lg shadow-lg p-4 border border-dark-200 dark:border-dark-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-dark-600 dark:text-dark-400">Compras Acumuladas</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-dark-300 dark:border-dark-600 rounded-lg bg-white dark:bg-dark-700 text-dark-900 dark:text-light-500 focus:ring-2 focus:ring-warning focus:border-transparent transition-all"
              required
            />
          </div>
          ...
          <div className="flex justify-end pt-4">
            <button
              type="submit"
              disabled={saving}
              className="flex items-center space-x-2 bg-warning hover:bg-warning-700 text-white px-6 py-3 rounded-lg font-semibold transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <FiSave />
